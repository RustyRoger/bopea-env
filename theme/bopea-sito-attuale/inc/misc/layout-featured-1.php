<?php
if ( ! function_exists( 'bopea_feature_layout_1' ) ) {
	function bopea_feature_layout_1( $attrs ) {
		$module = shortcode_atts( array(
			'blockid'            => '',
			'section_style'      => 'jl_feature_1',
			'post_type'          => 'post',
			'term_slugs'         => '',
			'post_type_tax'      => '',
			'category'           => '',
		...
		<div class="jl_mb_wrap_f jl_clear_at">
			...
			<?php bopea_feature_1_listing( $module, $query_data ); ?>			
			</div>
		</div>		
			<?php
			wp_reset_postdata();			
...
if ( ! function_exists( 'bopea_feature_1_listing' ) ) :
	function bopea_feature_1_listing( $module = array(), $query_data = null ) {
		if ( method_exists( $query_data, 'have_posts' ) ) :
			echo '<div class="jl_fr1_wrap"><div class="jl_fr1_inner">';
			$counter = 1;
			$get_main_ft = TRUE;
...
if ( ! function_exists( 'jl_post_layout_m_r' ) ) :
	function jl_post_layout_m_r( $module = array() ) {?>
		<div class="jl_p_fr1 jl_m_fr1 jl_ov_el jl_ov_mh">
			    ...
			    <div class="jl_fe_text">
			        ...
			        <<?php echo esc_attr($module['main_tag']);?> class="jl_fe_title jl_txt_2row"><a href="<?php the_permalink(); ?>"><?php the_title()?></a></<?php echo esc_attr($module['main_tag']);?>>
...
if ( ! function_exists( 'jl_post_layout_m_r_sm' ) ) :
	...
	<div class="jl_p_fr1 jl_ov_el jl_ov_sh jl_sm_mt">
			    <?php if ( has_post_thumbnail()) {?>
			        <div class="jl_img_holder">
				        <div class="jl_imgw">
				            <div class="jl_imgin">
			    ...
			    <div class="jl_fe_text">
			    	<div class="jl_fe_inner">
			    	<?php bopea_post_ov_cat(get_the_ID());?>
			        <<?php echo esc_attr($module['small_tag']);?> class="jl_fe_title jl_txt_2row"><a href="<?php the_permalink(); ?>"><?php the_title()?></a></<?php echo esc_attr($module['small_tag']);?>>			
			        <?php bopea_post_meta(get_the_ID());?>                
			        <a href="<?php the_permalink(); ?>" aria-label="<?php the_title()?>" class="jl_cap_ov"></a>
			        </div>
			    </div>
