<?php
if ( ! function_exists( 'bopea_feature_layout_20' ) ) {
	function bopea_feature_layout_20( $attrs ) {
		$module = shortcode_atts( array(
			'blockid'            => '',
			'section_style'      => 'jl_feature_20',
			'post_type'          => 'post',
			'term_slugs'         => '',
			'post_type_tax'      => '',
			'category'           => '',
		...
		<div class="jl_mb_wrap_f jl_clear_at">
			...
			<?php bopea_feature_20_listing( $module, $query_data ); ?>			
			</div>
		</div>			
			<?php
			wp_reset_postdata();			
...
if ( ! function_exists( 'bopea_feature_20_listing' ) ) :
	function bopea_feature_20_listing( $module = array(), $query_data = null ) {
		if ( method_exists( $query_data, 'have_posts' ) ) :
			echo '<div class="jl_fr20_wrap"><div class="jl_fr20_inner">';
			$counter = 0;
			while ( $query_data->have_posts() ) :
				$query_data->the_post();
				if($counter == 0){
					jl_layout_m_r_20( $module );				
				}elseif($counter == 1){
					jl_layout_m_r_mm_20( $module );				
				}else{
				jl_layout_m_r_sm_20( $module );
				}
				$counter ++;
			endwhile;
			echo '</div></div>';			
...
if ( ! function_exists( 'jl_layout_m_r_20' ) ) :
	function jl_layout_m_r_20( $module = array() ) {?>
		<div class="jl_p_fr20 jl_m_fr20 jl_ov_el">
				...
				<h3 class="jl_ovt"><?php the_title()?></h3>
			</div>
	<?php }
endif;

if ( ! function_exists( 'jl_layout_m_r_mm_20' ) ) :
	function jl_layout_m_r_mm_20( $module = array() ) {?>
	<div class="jl_p_fr20 jl_ov_el">
			    <?php if ( has_post_thumbnail()) {?>
			        <div class="jl_img_holder">
				        <div class="jl_imgw">
				            <div class="jl_imgin">
...
if ( ! function_exists( 'jl_layout_m_r_sm_20' ) ) :
	function jl_layout_m_r_sm_20( $module = array() ) {?>
	<div class="jl_p_fr20 jl_ov_el jl_sm_mt">
			    <?php if ( has_post_thumbnail()) {?>
			        <div class="jl_img_holder">
				        <div class="jl_imgw">
				            <div class="jl_imgin">
