<?php
if ( ! function_exists( 'bopea_mgrid_overlay' ) ) {
	function bopea_mgrid_overlay( $attrs ) {
		...
		if ( $query_data->have_posts() ) :
			$atts_style = 'jl-roww jl_contain jl_cgrid_wrap jl_ovg_w';
...
if ( ! function_exists( 'bopea_mgrid_overlay_listing' ) ) :
	function bopea_mgrid_overlay_listing( $module = array(), $query_data = null ) {
