<?php
if ( ! function_exists( 'bopea_sg' ) ) {
	function bopea_sg( $attrs ) {
		...
		<div class="jl_clear_at <?php echo esc_attr( $atts_style ); ?>" <?php bopea_get_ajax_attributes( $module, $query_data ); ?>>
			...
			<div class="jl_grid_wrap_f jl_wrap_eb jl_sf_grid jl_clear_at">
				<div class="<?php echo esc_attr( $atts_style ); ?>">
						<?php bopea_sg_listing( $module, $query_data );?>
				</div>
...
if ( ! function_exists( 'bopea_sg_listing' ) ) :
	function bopea_sg_listing( $module = array(), $query_data = null ) {
