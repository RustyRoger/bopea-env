<?php
if ( ! function_exists( 'bopea_feature_layout_19' ) ) {
	function bopea_feature_layout_19( $attrs ) {
		$module = shortcode_atts( array(
			'blockid'            => '',
			'section_style'      => 'jl_feature_19',
			'post_type'          => 'post',
			'term_slugs'         => '',
			'post_type_tax'      => '',
			'category'           => '',
		...
		<div class="jl_mb_wrap_f jl_clear_at">
			...
			<?php bopea_feature_19_listing( $module, $query_data ); ?>			
			</div>
		</div>			
			<?php
			wp_reset_postdata();			
...
if ( ! function_exists( 'bopea_feature_19_listing' ) ) :
	function bopea_feature_19_listing( $module = array(), $query_data = null ) {
		if ( method_exists( $query_data, 'have_posts' ) ) :
			echo '<div class="jl_fr19_wrap"><div class="jl_fr19_inner">';
			$counter = 0;
			while ( $query_data->have_posts() ) :
				$query_data->the_post();
				if($counter == 0){
					jl_layout_m_r_19( $module );				
				}elseif($counter == 1){
					jl_layout_m_r_mm_19( $module );				
				}else{
				jl_layout_m_r_sm_19( $module );
				}
				$counter ++;
			endwhile;
			echo '</div></div>';			
...
if ( ! function_exists( 'jl_layout_m_r_19' ) ) :
	function jl_layout_m_r_19( $module = array() ) {?>
		<div class="jl_p_fr19 jl_m_fr19 jl_ov_el jl_ov_mh">
...
if ( ! function_exists( 'jl_layout_m_r_mm_19' ) ) :
	function jl_layout_m_r_mm_19( $module = array() ) {?>
	<div class="jl_p_fr19 jl_ov_el jl_ov_sh jl_mm_mt jl_sm_mt">
			    <?php if ( has_post_thumbnail()) {?>
			        <div class="jl_img_holder">
				        <div class="jl_imgw">
				            <div class="jl_imgin">
...
if ( ! function_exists( 'jl_layout_m_r_sm_19' ) ) :
	function jl_layout_m_r_sm_19( $module = array() ) {?>
	<div class="jl_p_fr19 jl_ov_el jl_ov_sh jl_sm_g jl_sm_mt">
			    <?php if ( has_post_thumbnail()) {?>
			        <div class="jl_img_holder">
				        <div class="jl_imgw">
				            <div class="jl_imgin">
