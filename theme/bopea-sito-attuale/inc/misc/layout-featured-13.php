...
if ( ! function_exists( 'bopea_feature_layout_13' ) ) {
	function bopea_feature_layout_13( $attrs ) {
		$module = shortcode_atts( array(
			'blockid'            => '',
			'section_style'      => 'jl_feature_13',
			'post_type'          => 'post',
			'term_slugs'         => '',
			'post_type_tax'      => '',
			'category'           => '',
			...
			<div class="<?php echo esc_attr( $atts_style ); ?>">
				<div class="jl_fr13_wrap">
					<div class="jl_fr13_inner">
						<?php bopea_feature_13_listing( $module, $query_data ); ?>			
					</div>	
				</div>
			</div>
		</div>			
...
if ( ! function_exists( 'bopea_feature_13_listing' ) ) :
	function bopea_feature_13_listing( $module = array(), $query_data = null ) {
		if ( method_exists( $query_data, 'have_posts' ) ) :
			...
			while ( $query_data->have_posts() ) :				
				$query_data->the_post();								
				if($counter == 0){
					jl_layout_m_r_13( $module );
				}elseif ($counter == 1 || $counter == 2) {
					jl_layout_md_13( $module );
					if ($counter == 2) {
						echo '<div class="jl_fli_con jl_p_frli13"><div class="jl_fli_wrap">';
					}						
				}else{
					jl_layout_m_r_sm_13( $module );
				}				
				if(++$counter === $pnum) {
   					 echo "</div></div>";
  				}
...
if ( ! function_exists( 'jl_layout_m_r_13' ) ) :
	function jl_layout_m_r_13( $module = array() ) {?>
		<div class="jl_p_fr13 jl_m_fr13 <?php if ( 'yes' === $module['jl_en_frame'] ) {echo 'jl_en_fr jl_frg';} ?>">
			<div class="jl_m_fr13_inner jl_frsha">
...
if ( ! function_exists( 'jl_layout_md_13' ) ) :
	function jl_layout_md_13( $module = array() ) {?>
		<div class="jl_p_fr13 jl_cgrid_layout <?php if ( 'yes' === $module['jl_en_frame'] ) {echo 'jl_en_fr jl_frg';} ?>">
			<div class="jl_p_fr13_inner jl_frsha jl_sm_mt">
			    <?php if ( has_post_thumbnail()) {?>
			        <div class="jl_imgw jl_radus_e">
			            <div class="jl_imgin">
			                	<?php
...
if ( ! function_exists( 'jl_layout_m_r_sm_13' ) ) :
	function jl_layout_m_r_sm_13( $module = array() ) {?>
