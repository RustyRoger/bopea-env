<?php
if ( ! function_exists( 'bopea_feature_layout_10' ) ) {
	function bopea_feature_layout_10( $attrs ) {
		$module = shortcode_atts( array(
			'blockid'            => '',
			'section_style'      => 'jl_feature_10',
			'post_type'          => 'post',
			'term_slugs'         => '',
			'post_type_tax'      => '',
			'category'           => '',
		...
		<div class="jl_mb_wrap_f jl_clear_at">
			<div class="<?php echo esc_attr( $atts_style ); ?>">
				<div class="jl_fr10_wrap">
					<div class="jl_fr10_inner">
						<?php bopea_feature_10_listing( $module, $query_data ); ?>			
					</div>	
				</div>
			</div>
		</div>			
...
if ( ! function_exists( 'bopea_feature_10_listing' ) ) :
	function bopea_feature_10_listing( $module = array(), $query_data = null ) {
		if ( method_exists( $query_data, 'have_posts' ) ) :
			...
			while ( $query_data->have_posts() ) :				
				$query_data->the_post();								
				if($counter == 0){
					jl_layout_m_r_10( $module );
				}elseif ($counter == 1 || $counter == 2) {
					jl_layout_md_10( $module );
					if ($counter == 2) {
						echo '<div class="jl_fli_con jl_p_fr10"><div class="jl_fli_wrap">';
					}						
				}else{
					jl_layout_m_r_sm_10( $module );
				}				
				if(++$counter === $pnum) {
   					 echo "</div></div>";
  				}
...
if ( ! function_exists( 'jl_layout_m_r_10' ) ) :
	function jl_layout_m_r_10( $module = array() ) {?>
		<div class="jl_p_fr10 jl_m_fr10 jl_ov_el jl_radus_e">
...
if ( ! function_exists( 'jl_layout_md_10' ) ) :
	function jl_layout_md_10( $module = array() ) {?>
		<div class="jl_p_fr10 jl_ov_el jl_md_ov jl_radus_e">
			    <?php if ( has_post_thumbnail()) {?>
			        <div class="jl_img_holder">
				        <div class="jl_imgw">
				            <div class="jl_imgin">
...
if ( ! function_exists( 'jl_layout_m_r_sm_10' ) ) :
	function jl_layout_m_r_sm_10( $module = array() ) {?>
