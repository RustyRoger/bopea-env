...
<div class="jl_block_content">
    <div class="jlc-container">
        <div class="jlc-row main-content">
            ...
            echo '<div class="att-container-mobile" style="margin: 1rem 0">';
            ...
            echo bopea_feature_layout_7(array('blockid' => 'blockid_8c66666', 'category' => $category,'jl_hide_col_line'   => 'yes', 'pagination' => false));
			?>
